...
<body>
    <nav class="header">
        ...
        <div class="nav-menu">
            ...
            <a href="faq.php" class="nav-item">FAQ</a>
        </div>
        <div class="auth-buttons">
            <a href="logres.php" class="auth-btn">Login</a>
            <a href="logres.php" class="auth-btn">Register</a>
        </div>
    </nav>
    </header>
    <div class="hero">
        ...
        <div class="hero-image">
            <video autoplay muted loop class="background-video">
                <source src="video/12472898_1080_1920_24fps.mp4" type="video/mp4" />
    ...
    hamburger.addEventListener('click', () => {
        // Menambahkan atau menghapus kelas 'active' pada nav-menu untuk menunjukkan atau menyembunyikan menu
